...
//!
//! - the [`Memory`] trait + [`AgentEvent`] bus the agent emits through;
...
pub use bus::{AgentEvent, Memory, MemoryError};
...
pub use long_term_adapter::{agent_store, global_store, LongTermMemoryAdapter, AGENT_ID_PREFIX, GLOBAL_ID_PREFIX};
